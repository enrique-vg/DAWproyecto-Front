      ...
      <div class="stats-wrapper">
        ...
        <div class="stats-tabs" role="tablist" aria-label="Periodo de estadísticas">
          <button
            ...
            :aria-label="`Ver estadísticas por ${p.label}`"
        ...
        <Transition name="fade" mode="out-in">
          ...
          <div v-else-if="hayError" key="error" class="stats-error">
            ...
            <button class="btn btn--ghost btn--md" @click="statsStore.cargarProgreso()">
              <i class="pi pi-refresh" style="margin-right:0.4rem" aria-hidden="true"></i>
              Reintentar
            </button>
          </div>
          ...
          <div v-else key="datos" class="stats-datos">
            ...
            <div class="stats-card">
              <!-- Empty state si no hay datos en el gráfico -->
              <div
        ...
        <div v-if="statsStore.hitos.length" class="stats-hitos">
          ...
          <ul class="stats-hitos__lista" role="list">
            <li
              ...
              role="listitem"
            >
              <div class="hito-item__icono" aria-hidden="true">
        ...
        <div v-else-if="!statsStore.loading" class="stats-hitos-vacio" role="status">
